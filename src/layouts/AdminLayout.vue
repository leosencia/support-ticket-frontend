...
const isDashboardRoute = computed(() => route.path.startsWith('/admin/dashboard'))

const isManageTicketsRoute = computed(() => route.path.startsWith('/admin/tickets'))
